...
* Application is written using Java 21, Spring Boot, Liquibase, and JPA, running on the PostgreSQL database. It's currently running on a GCP thanks to [SoftwareMill](http://SoftwareMill.com).
