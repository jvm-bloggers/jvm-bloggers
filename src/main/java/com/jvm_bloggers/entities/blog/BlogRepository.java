...
public interface BlogRepository extends JpaRepository<Blog, Long> {
    ...
    @Query(""
        ...
        + "SUM(CASE WHEN (bp.publishedDate >= :first and bp.approved = true) THEN 1 ELSE 0 END) as firstCount, "
        + "SUM(CASE WHEN (bp.publishedDate >= :second and bp.approved = true) THEN 1 ELSE 0 END) as secondCount "
