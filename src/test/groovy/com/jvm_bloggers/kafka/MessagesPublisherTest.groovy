...
class MessagesPublisherTest extends SpringContextAwareSpecification {
	...
	private Map<String, String> javaToscalaMap(java.util.Map<String, String> kafkaSettings) {
		JavaConverters$.MODULE$.mapAsScalaMapConverter(kafkaSettings).asScala().toMap(
